...
| **Returns** | String | Comma-separated percentage values with 1 decimal, e.g. `"8.7,7.0,..."` |
...
4. Update the month labels and title in `index.html` (see [Architecture Reference](ARCHITECTURE.md))
