...
- [ ] Excel 2016 or later with macros enabled (see [Troubleshooting](TROUBLESHOOTING.md#macros-are-disabled) if macros are blocked)
...
5. If something looks wrong, see [Troubleshooting](TROUBLESHOOTING.md)
...
| Month labels | `MONTH_FULL` array in JS | "July 2025" through "June 2026" | "July 2026" through "June 2027" |
