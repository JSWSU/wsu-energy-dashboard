...
For detailed step-by-step instructions, see the [Operations Runbook](docs/OPERATIONS-RUNBOOK.md).
...
| Charts | [Chart.js](https://www.chartjs.org/) v4.4.7 (loaded via CDN) |
...
|----------|----------|---------------|
| [Operations Runbook](docs/OPERATIONS-RUNBOOK.md) | Non-technical operator | Step-by-step monthly update + FY rollover procedure |
| [Architecture Reference](docs/ARCHITECTURE.md) | Developer / IT | Code structure, auth, charts, KPIs, dark mode, print, tech debt |
| [Data Dictionary](docs/DATA-DICTIONARY.md) | Anyone | Every field in data.json: type, unit, Excel source, dashboard usage |
| [VBA Reference](docs/VBA-REFERENCE.md) | Developer / Excel power user | Macro functions, sheet-to-JSON mapping, verification logic |
| [Troubleshooting](docs/TROUBLESHOOTING.md) | Anyone | Common problems with symptoms, causes, and solutions |
